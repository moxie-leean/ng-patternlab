(function () {
    ...
    function lnOGravityFormController($log, $attrs, $element, lnOGravityFormService) {
        ...
        this.$onInit = function () {
            ...
            lnOGravityFormService.getForm(ctrl.id).then(function(response) {
                formConfig = response;
                // TODO: parse and render returned form config data.
                //       Do that here - or in a transformer before it gets here?
