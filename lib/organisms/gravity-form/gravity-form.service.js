...
function lnOGravityFormService($http, $cacheFactory, $q, $log, $lnOGravityFormConfig, lnOGravityFormGETFormTransformer) {
    ...
    function query(method, endpoint, params, clearCache, configParams, requiresAuth) {
        ...
        // sig: SxqEQx8tt68LEALq0izqJmM13z0%3
        // expires: 1461059296
        var config = {
            method: method,
            url: $lnOGravityFormConfig.url + endpoint + (requiresAuth ? formatAPIAuthParams($lnOGravityFormConfig.key, 'uw%2B6G62NfrKcWX6ku04qk6FIFNQ%3D', '1461059564') : ''),
            cache: true,
            headers: {
